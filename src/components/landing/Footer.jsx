    ...
    <footer className="bg-primary text-white">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href={`https://wa.me/${contact.whatsapp}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-primary-200 hover:text-white transition-colors">
                <Phone size={16} /><span className="text-sm">{contact.whatsappLabel}</span>
              </a>
              <a href="mailto:info@impulsolatino.com" className="flex items-center gap-3 text-primary-200 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="flex items-start gap-2 bg-white/5 rounded-xl p-4">
              ...
              <p className="text-primary-200 text-xs leading-relaxed">
                Financial Boost ofrece servicios de evaluación y gestión de préstamos.
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-primary-300 text-sm">© 2025 Financial Boost. Todos los derechos reservados.</p>
          <div className="flex gap-6">
            <a href="#" className="text-primary-300 hover:text-white text-sm transition-colors">Privacidad</a>
            <a href="#" className="text-primary-300 hover:text-white text-sm transition-colors">Términos</a>
            <Link to="/login" className="text-primary-300 hover:text-white text-sm transition-colors">Portal</Link>
          </div>
        </div>
      </div>
    </footer>
