              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-4 space-y-3 max-h-64 overflow-y-auto text-sm text-gray-700 mb-4">
                  <div>
                    ...
                    <p className="text-xs">
                      Entiendo que la información bancaria que proporciono será utilizada únicamente para procesar el desembolso de mi préstamo de forma segura y confidencial. Esta información será protegida según las políticas de seguridad de datos de Financial Boost.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs">
                      Soy responsable de mantener la confidencialidad de mis datos de acceso a la cuenta bancaria. Entiendo que no debo compartir esta información con terceros. Financial Boost nunca solicitará estos datos nuevamente.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs">
                      Confirmo que he completado correctamente todos los datos solicitados y autorizo a Financial Boost a proceder con el desembolso del monto pactado según los términos del contrato de préstamo.
                    </p>
                  </div>
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700">
                    He leído y acepto los términos, condiciones, política de privacidad y autorizo a Financial Boost a proceder con el desembolso.
                  </span>
                </label>
              </div>
            </div>
