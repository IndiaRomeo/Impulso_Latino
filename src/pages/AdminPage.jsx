      ...
      <div className="bg-primary shadow-lg">
        <div className="max-w-full px-4 py-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-4">
            <Link to="/" className="text-primary-200 hover:text-white transition-colors flex items-center gap-1 text-sm">
              <ArrowLeft size={16} /> Sitio
            </Link>
            <div className="w-px h-5 bg-white/20"></div>
            <Logo className="h-8 w-auto" />
            <div className="w-px h-5 bg-white/20"></div>
            <span className="text-primary-200 text-sm font-medium">Panel Admin</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button onClick={signOut} className="text-primary-300 hover:text-white text-sm transition-colors">Salir</button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-full px-4 py-4 md:py-6">
        {showFormLink && <div className="mb-5 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col lg:flex-row gap-3 lg:items-center">
          ...
          <button
            ...
            className="bg-primary hover:bg-primary-950 text-white font-semibold px-4 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm transition-colors"
          >
                    ...
                    <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-5 py-4">
                        <button
                          ...
                          className="text-xs font-semibold text-primary hover:text-primary-800 bg-primary/10 hover:bg-primary/20 px-3 py-1.5 rounded-lg transition-colors"
                        >
                          Editar
                        </button>
                      </td>
                  ...
                  <div key={msg.id} onClick={() => { setSelectedMsg(msg); markRead(msg) }}
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-center gap-2">
                        {!msg.leido && <div className="w-2 h-2 bg-secondary-500 rounded-full flex-shrink-0 mt-1.5"></div>}
                        <div>
              ...
              {!selectedMsg ? (
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    {selectedMsg.telefono && (
                      <a href={`https://wa.me/${selectedMsg.telefono.replace(/\D/g,'')}?text=${encodeURIComponent('Hola ' + selectedMsg.nombre + ', gracias por contactar a Financial Boost. ')}`}
                    ...
                    {selectedMsg.email && (
                      <a href={`mailto:${selectedMsg.email}?subject=Respuesta de Financial Boost`}
                        className="flex-1 bg-secondary hover:bg-secondary-700 text-white font-semibold py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm transition-colors">
